...
class Quest:
    ...
    def to_mongo(self) -> Dict:
        #converts quest obj into mongo dict
        data = {
    ...
    def from_mongo(cls, data: Dict) -> 'Quest':
        # creates quest obj from mongo dict
        if not data:
    ...
    def save_to_db(self, quests_collection: Collection,
        ...
        """
        saves the current quest object to mongo collection
        ...
        if self.mongo_id:
            ...
            print(f"quest {self.quest_id_str} inserted with mongo ID: {self.mongo_id}")
